...
const solutions = [
  {
    ...
    desc: 'Affordable, disaster-resilient, SDG-aligned housing deployed at national scale — without the delays and costs of traditional construction.',
    bullets: [
      'Verifiable SDG 1, 6, 8, 10, 11 & 13 outcomes',
      'Deploy from 10 to 10,000+ units',
      'Hurricane Cat.5 + Seismic Zone 4 certified',
      'Meets UN-Habitat and World Bank procurement standards',
    ],
  ...
  },
  {
    ...
    desc: 'Superior ROI, speed-to-market, and predictable costs. Othalo gives developers the edge in any market.',
    bullets: [
      '30–50% lower construction cost vs. concrete',
      '2-bedroom unit built in 72 hours',
      '100-unit development completed in under 3 months',
  ...
  },
  {
    ...
    desc: 'Partner with Othalo to turn your ESG commitments into measurable, independently verifiable impact on housing, waste, and communities.',
    bullets: [
      '8 tonnes of plastic diverted per 2BR unit built',
      'GRI, SASB & TCFD compatible impact reporting',
      '9 SDGs addressed per deployment',
      'Branded worker accommodation programs available',
    ],
