        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <SlotIn>
              ...
              <h2 className="font-heading text-3xl font-semibold text-navy mb-6">The limits of traditional building</h2>
              <ul className="space-y-4">
                {[
                  'Rising housing demand driven by rapid urbanisation and population growth',
                  'Increasing construction costs and budget constraints',
                  'Traditional building is slow, expensive, and high-carbon',
                  'Current methods are not viable at the required national scale',
                ].map((item, i) => (
            ...
            <SlotIn delay={0.15}>
              <div className="bg-navy rounded-sm p-8 lg:p-10 text-white shadow-lg">
                ...
                <h2 className="font-heading text-3xl font-semibold text-white mb-6">Scale without compromise</h2>
                <ul className="space-y-4">
                  {[
