...
export default function Corporations() {
  ...
  const benefits = [
    { icon: FileCheck, title: t('corporations.benefits.0.title'), desc: t('corporations.benefits.0.desc') },
    { icon: Leaf, title: t('corporations.benefits.1.title'), desc: t('corporations.benefits.1.desc') },
    { icon: Target, title: t('corporations.benefits.2.title'), desc: t('corporations.benefits.2.desc') },
    { icon: Clock, title: t('corporations.benefits.3.title'), desc: t('corporations.benefits.3.desc') },
    { icon: Handshake, title: t('corporations.benefits.4.title'), desc: t('corporations.benefits.4.desc') },
    { icon: BarChart2, title: t('corporations.benefits.5.title'), desc: t('corporations.benefits.5.desc') },
    { icon: Globe, title: t('corporations.benefits.6.title'), desc: t('corporations.benefits.6.desc') },
  ];

  const esgMetrics = t('corporations.metrics_items', { returnObjects: true });
          ...
          <SlotIn>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button asChild variant="outline" size="lg" className="border-white/30 text-white bg-transparent hover:bg-white/10 font-semibold px-8 h-12 rounded-sm text-base">
                <Link to="/contact">{t('corporations.cta2')}</Link>
              </Button>
            </div>
          </SlotIn>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <SlotIn>
              <div className="inline-flex items-center gap-2 text-navy/50 text-xs font-semibold uppercase tracking-widest mb-4 font-heading">
                ...
                {t('corporations.challenge_label')}
              </div>
              <h2 className="font-heading text-3xl font-semibold text-navy mb-6">{t('corporations.challenge_title')}</h2>
              <ul className="space-y-4">
                {t('corporations.challenge_bullets', { returnObjects: true }).map((item, i) => (
            ...
            <SlotIn delay={0.15}>
              <div className="bg-navy rounded-sm p-8 lg:p-10 text-white shadow-lg">
                <div className="inline-flex items-center gap-2 text-teal text-xs font-semibold uppercase tracking-widest mb-4 font-heading">
                  <span className="w-8 h-px bg-teal" />
                  {t('corporations.solution_label')}
                </div>
                <h2 className="font-heading text-3xl font-semibold text-white mb-6">{t('corporations.solution_title')}</h2>
                <ul className="space-y-4">
                  {t('corporations.solution_bullets', { returnObjects: true }).map((item, i) => (
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-12 text-center">
          <SlotIn>
            <h2 className="font-heading text-3xl font-semibold text-white mb-4">
              {t('corporations.cta_title')}
            </h2>
            <p className="text-white/80 max-w-lg mx-auto mb-8">
              {t('corporations.cta_subtitle')}
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button asChild variant="outline" size="lg" className="border-white/40 text-white bg-transparent hover:bg-white/10 font-semibold px-8 h-12 rounded-sm text-base">
                <Link to="/contact">{t('corporations.cta_contact')}</Link>
              </Button>
            </div>
          </SlotIn>
        </div>
